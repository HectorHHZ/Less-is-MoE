...
def _patch_transformers_qwen3_moe():
    """Inject pruned Qwen3-MoE classes into the transformers namespace so that
    ...
    apply_hf_patch("qwen3_moe")


class Qwen3MoePrunedAWQForCausalLM(BaseAWQForCausalLM):
