...
# A CUDA wheel may be installed on a login/build node where no GPU is visible.
# Classify the build from the PyTorch wheel, not current device availability,
# so that such nodes do not accidentally pull Intel Extension for PyTorch.
IS_CPU_ONLY = (
